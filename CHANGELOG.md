...
- Prepare npmjs, Go and crates.io publication with exact-commit public rehearsal and registry verification.
...
The candidate includes no endpoint runtime and does not claim completed Nightseam
adoption. The conformance baseline records its remaining profile/runtime obligations;
registry publication is recorded separately.
